...
_G.packer_plugins = {
  ...
  ["better-escape.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/better-escape.nvim",
  ...
  extensions = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/extensions",
  ...
  ["lsp_signature.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/lsp_signature.nvim",
  ...
  ["vim-eft"] = {
    loaded = true,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/vim-eft",
...
try_loadstring("\27LJ\2\0029\0\0\2\0\3\0\0066\0\0\0'\1\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\beft\18core.mappings\frequire\0", "setup", "vim-eft")
